        ...
        <div className="container-pad grid gap-8 py-12 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-3 flex gap-3">
              {settings?.facebookUrl && <a href={settings.facebookUrl} target="_blank" rel="noreferrer" aria-label="Facebook"><Facebook size={20} /></a>}
              {settings?.instagramUrl && <a href={settings.instagramUrl} target="_blank" rel="noreferrer" aria-label="Instagram"><Instagram size={20} /></a>}
              {settings?.youtubeUrl && <a href={settings.youtubeUrl} target="_blank" rel="noreferrer" aria-label="YouTube"><Youtube size={20} /></a>}
            </div>
          </div>
        </div>
      </footer>
